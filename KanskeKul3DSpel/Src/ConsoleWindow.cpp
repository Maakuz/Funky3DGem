...
ConsoleWindow::ConsoleWindow()
{
    ...
    colors.commandColor = ImVec4(70, 255, 70, 255);
    colors.errorColor = ImVec4(255, 50, 50, 255);
    colors.infoColor = ImVec4(255, 255, 255, 255);
    colors.fromOutsideColor = ImVec4(255, 0, 255, 255);
    colors.windowColor = ImVec4(0, 0, 0, 200);
...
inline void ConsoleWindow::addLog(std::string string, ImVec4 color)
{
    if (log.size() >= LOG_MAX)
    {
        log.erase(log.begin());
